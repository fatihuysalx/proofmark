...
const { initializeProofOnChain } = require("./services/anchorService"); // ✅ Anchor işlemi eklendi
...
app.post("/products", async (req, res) => {
  try {
    ...
    // ✅ Zincir üstüne kayıt
    await initializeProofOnChain(qrHash);
...
// ✅ Önümüzdeki adım: frontend'de kamera, dosya yükleme ve sürükle bırak desteği ile QR okuma işlemi yapılacak
